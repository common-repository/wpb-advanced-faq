...
function wpb_af_plugin_actions( $links ) {
	if( is_admin() ){
		$links[] = '<a href="http://wpbean.com/support/" target="_blank">'. esc_html__('Support', 'wpb-advanced-faq') .'</a>';
		$links[] = '<a style="color: red; font-weight: bold" href="'. esc_url( 'https://wpbean.com/downloads/wpb-advanced-faq-pro/' ) .'">'. __( 'Go PRO!', 'wpb-advanced-faq' ) .'</a>';
	}
	return $links;
}
